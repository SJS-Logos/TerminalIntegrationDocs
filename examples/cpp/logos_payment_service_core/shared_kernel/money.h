...
/// Shared Kernel Value Object representing monetary amounts.
/// Used by both Domain logic and Application contracts.
///
...
private:
    ...
    int64_t minor_units_;      // Amount in smallest currency unit
